...
def get_image_path(image_name):
    """Construit le chemin vers une image dans le dossier imgs"""
...
class RecordingAnimation(QWidget):
    def __init__(self, parent=None):
        ...
        self.bar_color = QColor(100, 149, 237)
        self.background_color = QColor(52, 53, 65)
        self.audio_handler = None
        
        self.gradient = QLinearGradient(0, 0, 0, self.height())
        self.gradient.setColorAt(0, QColor(100, 149, 237))
        self.gradient.setColorAt(1, QColor(70, 130, 180))
...
class AccountSettingsWidget(QWidget):
    ...
    def setup_ui(self):
        ...
        self.confirmation_label.setMinimumHeight(80)
    ...
    def hide_confirmation_message(self):
        ...
        print("Masquage du message de confirmation")  
        self.confirmation_label.hide()
        QApplication.processEvents()
    ...
    def on_save_clicked(self):
        ...
        try:
            ...
            print(f"Interprète: {is_interpreter}, Langue: {selected_language}")  
            ...
            if main_window:
                ...
                def continue_operations():
                    ...
                    print("Agent mis à jour")  
                    
                    main_window.clear_conversations()
                    print("Conversations effacées")  
...
class CustomMessageWindow(QWidget):
    ...
    def save_settings(self):
        print("Méthode save_settings appelée")  
        try:
            is_interpreter = self.interpreter_checkbox.isChecked()
            selected_language = self.language_combo.currentText()
            print(f"Interprète: {is_interpreter}, Langue: {selected_language}")  
            ...
            if hasattr(self.parent(), 'update_agent_mode'):
                ...
                if main_window:
                    ...
                    print("Tentative d'affichage de la fenêtre de message")  
                    message_window.show()
            ...
            if main_window:
                ...
                print("Impossible d'afficher la fenêtre d'erreur : fenêtre principale non trouvée")  
...
class frame(QMainWindow):
    ...
    def create_demo_frame(self):
        ...
        logo = QLabel()
        logo.setPixmap(QPixmap(get_image_path("logoIA.png")).scaled(36,36))
        ...
        for section_title, icon_path, items in [
            ...
            ("Capacités", "2.png", [
                "conversations ",
                "Permet les corrections",
                "Discours civilisé"
            ]),
            ("Limitations", "3.png", [
                "informations correctes",
                "contenu biaisé parfois",
                "Savoir limitées"
            ])
        ]:
            section = QWidget()
            ...
            icon = QLabel()
            icon.setPixmap(QPixmap(get_image_path(icon_path)).scaled(24,24))
    ...
    def lato(self):
        ...
        """)
        info1.setIcon(QIcon(QPixmap(get_image_path("12.png")).scaled(20,20)))
        ...
        """)
        info2.setIcon(QIcon(QPixmap(get_image_path("12.png")).scaled(20,20)))
        ...
        """)
        info3.setIcon(QIcon(QPixmap(get_image_path("12.png")).scaled(20,20)))
        ...
        """)
        info1_1.setIcon(QIcon(QPixmap(get_image_path("11.png")).scaled(20,20)))
        ...
        """)
        info2_2.setIcon(QIcon(QPixmap(get_image_path("10.png")).scaled(20,20)))
        ...
        """)
        info3_3.setIcon(QIcon(QPixmap(get_image_path("9.png")).scaled(20,20)))
        ...
        """)
        info4_4.setIcon(QIcon(QPixmap(get_image_path("8.png")).scaled(20,20)))
        ...
        """)
        info5_5.setIcon(QIcon(QPixmap(get_image_path("7.png")).scaled(20,20)))
    ...
    def centro(self):
        ...
        micro = QPushButton()
        micro.setIcon(QIcon(QPixmap(get_image_path("4.png")).scaled(20,20)))
        micro.setStyleSheet("""
            QPushButton {
                border: none;
                padding: 5px;
        ...
        img = QPushButton()
        img.setIcon(QIcon(QPixmap(get_image_path("5.png")).scaled(20,20)))
        img.setStyleSheet("""
            QPushButton {
                border: none;
                padding: 5px;
        ...
        send = QPushButton()
        send.setIcon(QIcon(QPixmap(get_image_path("6.png")).scaled(20,20)))
        send.setStyleSheet("""
            QPushButton {
                border: none;
                padding: 5px;
    ...
    def update_agent_mode(self, is_interpreter, target_language):
        print("Mise à jour du mode de l'agent")  
        try:
            if is_interpreter:
                print(f"Activation du mode interprète pour la langue : {target_language}")  
                
                self.gemini_agent.update_prompt_for_interpreter(target_language)
            else:
                print("Activation du mode conversationnel")  
                
                self.gemini_agent.restore_normal_prompt()
            print("Mode de l'agent mis à jour avec succès")  
        except Exception as e:
            print(f"Erreur lors de la mise à jour du mode de l'agent : {str(e)}")  
            raise e
